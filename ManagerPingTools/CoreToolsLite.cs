...
[McpServerToolType]
public class CoreToolsLite(AzureDevOpsService adoService)
{
    ...
    public async Task<IEnumerable<TeamProjectReference>> ListProjects(
        ...
        [Description("Filter projects by name. Supports partial matches.")] string projectNameFilter = ""
    )
    {
    ...
    public async Task<IEnumerable<WebApiTeam>> ListTeams(
